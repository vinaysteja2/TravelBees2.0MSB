...
public AuthResponse generateToken(String username) {
   ...
   public User getByEmail(ForgotPassword forgotPassword) {
	   
	   if (!userCredentialRepository.existsByEmail(forgotPassword.getEmail() )) {
           throw new UserException("please provide registered EmailId");
       }
	    return userCredentialRepository.findByEmail(forgotPassword.getEmail());
	   
   }
   
 
   public boolean updatePassword(String email, String newPassword) {
       User userOptional = userCredentialRepository.findByEmail(email);
